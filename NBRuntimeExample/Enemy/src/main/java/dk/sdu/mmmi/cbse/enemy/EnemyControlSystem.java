    ...
    public void process(GameData gameData, World world) {
        for (Entity enemy : world.getEntities(ENEMY)) {
            ...
            if (enemy.getLife() <= 0) {
                ...
                enemy = null;
                System.out.println("Enemy killed - " + world.getEntities(ENEMY).size() + " enemies left");
            } else {
...
//                }
    ...
    private void findTarget(Entity enemy, Entity e, GameData gameData) {
        float radians = enemy.getRadians();
...
//            shapey[3] = e.getY();
            ...
            if (rnde.nextInt(10) == 2) {
                ...
                Event event = new Event(EventType.ENEMY_SHOOT, enemy.getID());
