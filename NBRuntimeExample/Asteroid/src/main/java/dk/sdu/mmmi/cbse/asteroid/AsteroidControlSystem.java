...
public class AsteroidControlSystem implements IEntityProcessingService, IGamePluginService {
    ...
    public void process(GameData gameData, World world) {
        for (Entity asteroid : world.getEntities(ASTEROIDS)) {
            ...
            if (asteroid.getIsHit()) {
                ...
                a1.setType(EntityType.ASTEROIDS);
                a2.setType(EntityType.ASTEROIDS);
    ...
    public void stop(GameData gameData, World world) {
        for(Entity ast : world.getEntities(ASTEROIDS)){
